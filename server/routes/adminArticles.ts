...
try {
  if (supabaseUrl && supabaseKey) {
    ...
    console.warn('⚠️  Supabase credentials not configured. Article management features will be unavailable.');
  }
} catch (error) {
  console.error('Error initializing Supabase client for adminArticles:', error);
}
