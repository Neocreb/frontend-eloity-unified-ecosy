        ...
        <div className="px-4 py-3 sm:px-6 space-y-2">
          {isLoading ? (
            <div className="text-center py-12">
              <p className="text-muted-foreground dark:text-slate-400">Loading following list...</p>
            </div>
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium mb-2 dark:text-white">Not following anyone</h3>
              <p className="text-muted-foreground text-sm px-4 dark:text-slate-400">
                {searchQuery ? "No users match your search" : "Follow people to see their content!"}
              </p>
            </div>
          ) : (
