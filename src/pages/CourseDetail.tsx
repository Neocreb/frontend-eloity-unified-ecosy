...
interface Enrollment {
  ...
  enrollment_reward_claimed: boolean;
  completion_reward_claimed: boolean;
  certificate_reward_claimed: boolean;
}
    ...
    try {
      ...
      await supabase
        ...
        .insert({
          ...
          amount: course.reward_enrollment,
        });
                ...
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {course.course_type === 'creator' && (
                          <Badge variant="outline">Community Course</Badge>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="mb-6">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm text-muted-foreground">
                          {enrollment.completed_lessons.length}/{lessons.length} lessons
                        </span>
                      </div>
                  ...
                  <Card className="mb-6 border-amber-200 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-amber-800 dark:text-amber-200">Earn Rewards</h4>
                          <p className="text-xs text-amber-700 dark:text-amber-300">
                            Gain points by learning
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-700 dark:text-gray-300">
                            Enroll: {course.reward_enrollment} pts
                          </span>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-700 dark:text-gray-300">
                            Complete: {course.reward_completion} pts
                          </span>
                        </div>
                        ...
                        {course.has_certificate && (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-700 dark:text-gray-300">
                              Cert: {course.reward_certificate} pts
                            </span>
                          </div>
                        )}
                      </div>
                  ...
                  {!enrollment ? (
                    ...
                    >
                      {enrolling ? (
                        ...
                        <>
                          ...
                          Enroll Now {course.is_paid ? `- $${course.price}` : '- Free'}
                        </>
                      )}
                    </Button>
                  ) : (
                    <div className="flex gap-3">
                      <Button
                        onClick={() => {
                          const nextLesson = lessons.find(
                            l => !enrollment.completed_lessons.includes(l.id)
                          );
                          if (nextLesson) {
                      ...
                      {enrollment.progress_percentage === 100 && course.has_certificate && (
                  ...
                  <div className="space-y-4">
                    {lessons.length === 0 ? (
                      ...
                      lessons.map((lesson, index) => {
                        ...
                        const isLocked = !enrollment || (index > 0 && !enrollment.completed_lessons.includes(lessons[index - 1].id));
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <p className="text-sm text-muted-foreground">
                            ...
                            certificate that you can share on your professional profiles.
                          </p>
                        </CardContent>
                      </Card>
                    )}
                  ...
                  <Card>
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-grow">
                          <h3 className="text-xl font-bold mb-1">{course.instructor_name}</h3>
                          <p className="text-muted-foreground mb-3">{course.instructor_title}</p>
                          <p className="text-sm">{course.instructor_bio}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-medium">{course.total_students}</span>
                  </div>
                  <Separator />
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant={course.has_certificate ? 'default' : 'secondary'}>
                      {course.has_certificate ? 'Included' : 'Not included'}
                    </Badge>
                  </div>
                </CardContent>
              </Card>
